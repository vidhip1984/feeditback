package to.feeditback.tst.utility;

import org.apache.commons.io.FileUtils;
import org.openqa.selenium.*;
import to.feeditback.tst.browserfactory.ManageBrowser;
...
public class Utility extends ManageBrowser {
    ...
    public static void takeScreenShot() {
        String filePath = System.getProperty("user.dir") + "/src/main/java/to/feeditback/tst/screenshots/";
    ...
    public static String getScreenshot(WebDriver driver, String screenshotName) {
        ...
        String destination = System.getProperty("user.dir") + "/src/main/java/to/feeditback/tst/screenshots/" + screenshotName + dateName + ".png";
